# Golden run: stale-sensor-baseline

Raw samples: `benchmarks/runs/stale-sensor-baseline.jsonl` (75 total). Regenerate with `tools/run_golden_benchmark.sh`.
...
| Field | Value |
|---|---|
| captured_at_utc | 2026-07-28T15:45:55.303792+00:00 |

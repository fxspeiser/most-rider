# Golden run: stale-sensor-faulted

Raw samples: `benchmarks/runs/stale-sensor-faulted.jsonl` (68 total). Regenerate with `tools/run_golden_benchmark.sh`.
...
| Field | Value |
|---|---|
| captured_at_utc | 2026-07-28T15:46:18.360125+00:00 |

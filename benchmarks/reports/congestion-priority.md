# Golden run: congestion-priority

Raw samples: `benchmarks/runs/congestion-priority.jsonl` (1414 total). Regenerate with `tools/run_golden_benchmark.sh`.
...
| Field | Value |
|---|---|
| captured_at_utc | 2026-07-28T15:08:15.132298+00:00 |

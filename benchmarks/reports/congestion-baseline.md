# Golden run: congestion-baseline

Raw samples: `benchmarks/runs/congestion-baseline.jsonl` (1425 total). Regenerate with `tools/run_golden_benchmark.sh`.
...
| Field | Value |
|---|---|
| captured_at_utc | 2026-07-28T15:06:55.016315+00:00 |
